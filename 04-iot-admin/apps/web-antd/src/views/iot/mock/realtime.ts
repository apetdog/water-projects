...
const baseRealtimeList: RealtimeItem[] = [
  {
    ...
    name: '温湿度传感器 A',
    status: 'online',
    lastActive: '2025-12-09 10:30:00',
  },
  {
    id: 'DEV-002',
    name: '智能电表 B',
    status: 'offline',
    lastActive: '2025-12-08 14:20:00',
  },
  {
    id: 'DEV-003',
    name: '压力控制器 C',
    status: 'alarm',
    lastActive: '2025-12-09 10:29:55',
  },
  {
    id: 'DEV-004',
    name: '水质监测站 D',
    status: 'online',
    lastActive: '2025-12-09 10:35:12',
  },
  {
    id: 'DEV-005',
    name: '视频监控 E',
    status: 'online',
    lastActive: '2025-12-09 10:35:10',
  },
];
...
const generatedRealtimeList: RealtimeItem[] = Array.from({ length: 13 }).map((_, index) => {
  ...
  return {
    ...
    lastActive: `2025-12-09 ${10 + Math.floor(index / 10)}:${10 + (index % 50)}:00`,
  };
});
