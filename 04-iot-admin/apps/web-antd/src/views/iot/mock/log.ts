...
const baseLogData: LogItem[] = [
  ...
  },
  {
    ...
    rawData: '{"Func":3,"Dev":"002512010117","Data":{"Data":[{"DT":"2025-12-09T11:00:00","GID":"","Field":[{"Name":"水黑液位","ID":"1","DT":2,"WT":0,"Val":"3344"},{"Name":"雨量计","ID":"5","DT":2,"WT":0,"Val":""}]}]}}',
    info: '数据点:1.7788.',
  },
];
...
const generatedLogData: LogItem[] = Array.from({ length: 14 }).map((_, index) => {
  ...
  return {
    ...
    type: types[index % 3],
    name: `模拟日志 ${id}`,
    time: `2025-12-09 ${18 - Math.floor(index / 6)}:${59 - (index % 60)}`,
