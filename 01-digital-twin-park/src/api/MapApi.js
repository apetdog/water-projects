...
class MapApi {
  ...
  addFloorPicture() {
    ...
    let pictrue5 = this._layer.addMarker({
      id: 'cameraSevice55',
      data: floorPoints,
    });
  ...
  addPoi() {
    ...
    let pictrue3 = this._layer.addMarker({
      id: 'cameraSevice33',
      data: icon2Points,
    });
  ...
  addAreaPicture() {
    ...
    let pictrue = this._layer.addMarker({
      id: 'cameraSevice11',
      data: iconPoints,
    });
  ...
  addIndoorSplit() {
    ...
    let polygon2 = this._layer.addPolygons({
      color: 0x0000ff,
      opacity: 0.3,
      data: [
        {
    ...
    let polygon3 = this._layer.addPolygons({
      color: 0x00ff00,
      opacity: 0.3,
      data: [
        {
    ...
    let polygon4 = this._layer.addPolygons({
      color: 0x800080,
      opacity: 0.3,
      data: [
        {
    ...
    let polygon5 = this._layer.addPolygons({
      color: 0xff0000,
      opacity: 0.3,
      data: [
        {
